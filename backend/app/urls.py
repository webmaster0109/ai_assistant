...
urlpatterns = [
    ...
    path('api/background-jobs/', views.background_job_list, name='background_job_list'),
    path('api/background-jobs/<str:job_id>/', views.background_job_detail, name='background_job_detail'),
    ...
    path('api/learning/quizzes/<int:quiz_id>/delete/', views.delete_learning_quiz, name='delete_learning_quiz'),
    ...
    path('api/roast-mode/', views.create_roast, name='create_roast'),
    path('api/fortune-mode/', views.create_fortune, name='create_fortune'),
    path('api/movie-recommendations/', views.create_movie_recommendations, name='create_movie_recommendations'),
    path('api/chat/', views.chat_post, name='chat_post'),
    path('api/chat/documents/', views.upload_chat_document, name='upload_chat_document'),
    path('api/chat/images/', views.upload_chat_image, name='upload_chat_image'),
    path(
    ...
    path(
        'api/chat/sessions/<str:session_id>/documents/<int:document_id>/deactivate/',
        views.deactivate_chat_document,
        name='deactivate_chat_document',
    ),
    path(
        'api/chat/sessions/<str:session_id>/documents/<int:document_id>/',
        views.delete_chat_document,
        name='delete_chat_document',
    ),
    path(
        'api/chat/sessions/<str:session_id>/images/<int:image_id>/select/',
        views.select_chat_image,
        name='select_chat_image',
    ),
    path(
        'api/chat/sessions/<str:session_id>/images/<int:image_id>/deactivate/',
        views.deactivate_chat_image,
        name='deactivate_chat_image',
    ),
    path(
        'api/chat/sessions/<str:session_id>/images/deactivate-all/',
        views.deactivate_all_chat_images,
        name='deactivate_all_chat_images',
    ),
    path(
        'api/chat/sessions/<str:session_id>/images/<int:image_id>/',
        views.delete_chat_image,
        name='delete_chat_image',
    ),
    ...
    path('api/chat/sessions/search/', views.search_chat_sessions, name='chat_sessions_search'),
